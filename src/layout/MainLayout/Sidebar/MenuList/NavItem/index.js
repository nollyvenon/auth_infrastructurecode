...
const NavItem = ({ item, level }) => {
  ...
  return (
    <ListItemButton
      ...
      selected={customization && customization.isOpen === item.id}
      component={Link}
    ...
    >
      ...
      <ListItemText
        primary={
          <Typography sx={{ pl: 1.4 }} variant={customization && customization.isOpen === item.id ? 'subtitle1' : 'body1'} color="inherit">
            {item.title}
          </Typography>
        }
        secondary={
